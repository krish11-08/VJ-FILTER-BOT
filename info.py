...
LOG_CHANNEL = int(environ.get('1375913811', ''))
...
auth_channel = environ.get('https://t.me/+VzXU85mBJD81ZmY9', '') # give your force subscribe channel id here else leave it blank
